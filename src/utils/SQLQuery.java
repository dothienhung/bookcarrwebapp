...
public interface SQLQuery {
	...
	String LIST_ALL_TICKET = "SELECT t.ticketId, tr.destination, t.customerName, t.licensePlate, t.bookingTime, t.tripId FROM Ticket t JOIN Trip tr ON t.tripId = tr.tripId";
