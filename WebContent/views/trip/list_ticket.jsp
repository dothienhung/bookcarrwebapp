...
<body>
	...
	<div class="h-100 d-flex flex-column">
		<nav class="navbar navbar-light bg-light py-3">
			<span class="navbar-brand"> <span class="fas fa-ticket-alt"></span>
				Ticket <a style="margin-left: 210px;"
						...
						<div class="d-flex justify-content-end">
							<div class="btn-group mr-4 w-25">
								...
								<input type="text" name="search" id="search"
									class="form-control" placeholder="Ticket search">
							</div>
							<div class="btn-group">
						...
						<table class="table table-bordered table-striped mt-3" id="table">
							...
							<c:forEach items="${ticket}" var="ticket">
								<tr>
									...
									<td><a
										href="<%=request.getContextPath()%>/delete_ticket?ticketId=${ticket.ticketId}&tripId=${ticket.tripId}"
