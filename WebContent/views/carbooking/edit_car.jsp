		...
		<div class="d-flex flex-grow-1">
			...
			<div class="col-md-10 border border-success">
				<div class="p-4">
					...
					<hr>
					<form
						action="<%=request.getContextPath()%>/editcar?liecensePl=${car.licensePlate}"
